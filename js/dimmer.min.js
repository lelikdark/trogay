...
!function (e, i, n, t) {
    ...
    e.fn.dimmer = function (i) {
        ...
        return a.each(function () {
            var u, l, f, g = e.isPlainObject(i) ? e.extend(!0, {}, e.fn.dimmer.settings, i) : e.extend({}, e.fn.dimmer.settings), p = g.selector, v = g.namespace, b = g.className, h = g.error, C = "." + v, y = "module-" + v, w = a.selector || "", S = "ontouchstart"in n.documentElement ? "touchstart" : "click", D = e(this), T = this, N = D.data(y);
            f = {
                preinitialize: function () {
                    ...
                    f.verbose("Storing instance of module", f), N = f, D.data(y, N)
                }, destroy: function () {
                    f.verbose("Destroying previous module", u), f.unbind.events(), f.remove.variation(), l.off(C)
                }, bind: {
                    events: function () {
                        "hover" == g.on ? l.on("mouseenter" + C, f.show).on("mouseleave" + C, f.hide) : "click" == g.on && l.on(S + C, f.toggle), f.is.page() && (f.debug("Setting as a page dimmer", l), f.set.pageDimmer()), f.is.closable() && (f.verbose("Adding dimmer close event", u), l.on(S + C, p.dimmer, f.event.click))
                    }
                }, unbind: {
                    events: function () {
                        D.removeData(y)
                    ...
                    opacity: function (e) {
                        ...
                        e = g.opacity || e, t ? (n[3] = e + ")", i = n.join(",")) : i = "rgba(0, 0, 0, " + e + ")", f.debug("Setting opacity to", e), u.css("background-color", i)
                    }, active: function () {
                        u.addClass(b.active)
                    }, dimmable: function () {
